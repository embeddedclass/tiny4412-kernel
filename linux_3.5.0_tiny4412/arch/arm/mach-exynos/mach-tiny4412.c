...
// Add by terence start
//#define MY_MEM_START 0x11000000
//#define MY_MEM_END   0x02E8

static struct resource my_button_resource[] = {
	[0] = DEFINE_RES_IRQ(EXYNOS4_GPX3(2)),
};

struct platform_device my_button_device = {
        .name           = "my_button_platform",
        .num_resources  = ARRAY_SIZE(my_button_resource),
        .resource       = my_button_resource,
};
// Add by terence end
